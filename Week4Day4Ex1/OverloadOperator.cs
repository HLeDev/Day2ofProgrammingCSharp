            ...
            while (yes == 'y')
            {
                ...
                switch (choice)
                {
                    case 1:
                        ...
                        addResult = Add(a, b); // Add is an overload function as Line 106 and 110 are both Add
...
class Circle //Operator
{
        ...
        while (yes == 'y')
        {
            ...
            switch (choice)
            {
                case 1:
                    ...
                    Circle firstCirA = new Circle(Convert.ToInt32(Console.ReadLine())); //the number is automatically calculated for area base off line 214
                    Console.WriteLine("\t Please enter the radius of the second circle");
                    Circle secCirA = new Circle(Convert.ToInt32(Console.ReadLine())); //the number is automatically calculated for area base off line 214
                    Console.WriteLine("\n");
                    Console.WriteLine("\t Lets get the area of each circle!");
                    Console.WriteLine("\t --------------------------------------");
                    Console.WriteLine("\t Lets find the area of the first circle");
                    Console.WriteLine($"\t The radius that you enter is [ {firstCirA._radius} ] and the area is: |[ {firstCirA.area} ]|"); //calling the radius and area to be printed out
                    Console.WriteLine("\n");
    ...
    private double radius; //making radius private on back end
    public double _radius //receiving  radius input and sending it back to back end
    {
        get { return this.radius; } //wrtite this
        set { this.radius = value; } //input this from user
    ...
    // created Circle function so that whenever radius is called, it'll will automatically calculate the area by ending with .area
    {
            this.radius = radius;
            this.area = calcarea();
    ...
    //this is so we can call the function calcarea, and when we call it, it'll return the formula automatically by inputting the radius
    //that was inputted by the user from line 204/205
    {
